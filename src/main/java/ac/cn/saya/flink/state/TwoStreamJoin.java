...
public class TwoStreamJoin{
   ...
   public static void main(String[] args) throws Exception {
      ...
      stream1.keyBy(data -> data.f0).connect(stream2.keyBy(data -> data.f0)).process(new CoProcessFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>, String>() {
         // 定义列表状态，用于保存两条流中已经到达的数据
